    ...
    function JSONToCSVConvertor(JSONData, ReportTitle, ShowLabel) {
        ...
        $("#jsGrid").jsGrid({
            ...
            fields: [
                ...
                { name: "downloadcontcat", itemTemplate: function(value) {
                            return $("<a>").attr({href: "#", class: "contcat-download-link"}).text("Download");
                        }, width: 100, title: "Content Categories" },
            ],
...
//                        console.log("ngram-download-link click");
    ...
    //                                }
                        ...
                        var query = selectedItem.reqKw.toLowerCase();
//                        console.log(query);
                        $.ajax({
                            type: 'GET',
...
//                                console.log(parsed_data);
                    ...
                    else if($selectedCellClass == 'contcat-download-link'){
                        //console.log("contcat-download-link click");
                        var query = selectedItem.reqKw.toLowerCase();
//                        console.log(query);
                        $.ajax({
                            type: 'GET',
                            url: '/service/download_contcat',
                            headers: {
                                'X-CSRFToken': $.cookie('X-CSRFToken')
                            },
                            data:  {'name': query , },
...
//                                console.log(response);
                                try{
                                parsed_data= JSONToCSVConvertor(JSON.parse(response), "Content Categories", true);
//                                console.log(parsed_data);
                                var mime_type = mime_type || "text/csv";
