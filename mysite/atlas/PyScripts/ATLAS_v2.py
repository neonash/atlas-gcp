#import HomeDepot
# import Amazon_I1
import Amazon_LtdLoops_v2 as Amazon
#import Walmart
...
def main(kw_str, site):
    ...
    for s in site:
        ...
        if s == "am":
            try:
                ...
                status.append(200)
                print("Status Code for Amazon: 200")
            except:
                status.append(500)
                print("Status Code for Amazon: 500")
                # print(traceback.print_exc())
    ...
    rev_data = Review.objects.filter(rid__contains=kw_str).values()
    for i in rev_data:
        # print(i)
