...
# To run analysis on uploaded file with tag dict
def td_main3(kw_str, tddict):
    global status_code
    ...
    try:
        ...
        revs_df = Social.objects.filter(dataset_filename=kw_str).only('rid', 'rText').values()
        ...
        for r in revs_df:
            ...
            try:
                ...
                analysis_obj = SocialAnalyses.objects.create(aid=soc_obj)

            kw = pd.read_csv(tddict)
            ...
            for each_kw in range(len(kw)):
                ...
                if re.findall(kw.ix[each_kw, 'Keywords'], curr_rev, re.I):
                    ...
                    try:
                        ...
                        print("..")
                        # print("Error while updating socialanalyses table!")
                        # print(traceback.print_exc())
